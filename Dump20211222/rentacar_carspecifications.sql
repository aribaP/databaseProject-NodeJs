...
DROP TABLE IF EXISTS `carspecifications`;
...
CREATE TABLE `carspecifications` (
  ...
  `WirelessTech` enum('Yes','No') NOT NULL,
  `EngineCapacity` decimal(3,0) NOT NULL,
  `Fuel` decimal(3,0) NOT NULL,
  `Transmission` enum('Auto','Manual') NOT NULL,
  PRIMARY KEY (`NumberPlate`),
  KEY `BodyType_idx` (`BodyType`),
  CONSTRAINT `BodyType` FOREIGN KEY (`BodyType`) REFERENCES `bodytype` (`Typee`)
